...
//#region node_modules/.nitro/vite/services/ssr/assets/router-s-6MzCZO.js
var router_s_6MzCZO_exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-B1zTIvk3.css";
var APP_NAME = "Lagoon";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Interactive WebGL water and a tropical island. Draw ripples, drag the glass sphere, watch the lagoon."
			},
			{
			...
			},
			{
				...
				content: "Interactive WebGL water and a tropical island."
			},
			...[],
			...[]
		],
...
var $$splitComponentImporter$1 = () => import("./routes-_SNSACFu.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-DZyzgbtr.mjs");
...
//#endregion
export { router_s_6MzCZO_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
